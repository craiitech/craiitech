        ...
        {view === 'evaluation' && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <CardHeader className="text-center pb-8 border-b bg-primary/5">
              ...
              <CardTitle className="text-2xl font-black uppercase text-slate-900 dark:text-slate-100">
                Final Quality Audit
              </CardTitle>
            ...
            <CardContent className="p-8 space-y-6 text-center">
              <p className="text-sm font-medium text-slate-600 dark:text-slate-400 leading-relaxed font-sans">
                To maintain our **ISO 21001:2018 Certification**, we require all stakeholders to evaluate the portal
                maturity index. Please complete the assessment before signing out.
              </p>
            </CardContent>
            <CardFooter className="p-8 pt-0 flex flex-col gap-3">
              ...
              >
                Start ISO 25010 Audit <ChevronRight className="ml-2 h-5 w-5" />
              </Button>
              <Button
                variant="ghost"
                className="w-full text-slate-400 font-bold"
                onClick={() => setView(isAdmin ? 'backup' : 'feedback')}
              >
        ...
        {view === 'backup' && (
          <div className="animate-in fade-in duration-500">
            ...
            <CardContent className="pt-8 space-y-4">
              <p className="text-sm text-slate-600 dark:text-slate-400 font-medium leading-relaxed font-sans text-center">
                Administrator detected. Perform a full system backup before ending this session?
              </p>
            </CardContent>
        ...
        {view === 'feedback' && (
          <div className="animate-in fade-in duration-500">
            ...
            <CardFooter className="flex flex-col gap-3 pb-8">
              ...
              <Button variant="ghost" className="w-full text-muted-foreground" onClick={() => handleFinalLogout(true)}>
                Skip and Logout
              </Button>
            </CardFooter>
          </div>
