...
const features = [
    ...
    },
    {
        ...
        desc: "ISO 6.1 Compliance. Integrated digital registry for identifying, analyzing, and mitigating institutional vulnerabilities with structured baseline and residual impact assessment.",
