...
import { collection, query, orderBy, Timestamp } from '@/firebase/firestore-wrapper';
...
export default function QaAdvisoriesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="sticky top-0 z-20 bg-background/95 backdrop-blur-md pt-2 pb-4 -mx-4 px-4 lg:-mx-8 lg:px-8 border-b flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
