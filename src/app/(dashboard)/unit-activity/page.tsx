      ...
      <html>
        <head>
          ...
          <style>
            ...
            .header-container { display: flex; align-items: center; justify-content: center; gap: 1in; border-bottom: 2px solid black; padding-bottom: 8px; margin-bottom: 15px; }
            .header-logo-left { width: 65px; text-align: center; flex-shrink: 0; }
            .header-logo-left img { height: 55px; object-fit: contain; display: block; margin: 0 auto; }
            ...
            .header-logo-right { width: 95px; text-align: center; flex-shrink: 0; }
            .header-logo-right img { height: 55px; object-fit: contain; display: block; margin: 0 auto; }
