...
const KPI_DEFINITIONS = [
  ...
  {
    name: 'Activity Participation Rate',
    description: 'Percentage of planned unit activities that have documented attendance.',
    category: 'faculty_evaluation',
    formula: 'activity_participation_rate',
  ...
  {
    name: 'Activity Attendance Punctuality',
    description: 'Percentage of activity attendees who arrived on time.',
    category: 'faculty_evaluation',
    formula: 'activity_on_time_punctuality',
  ...
  {
    name: 'Activity Evaluation Score',
    description: 'Average participant evaluation score across all unit activities.',
    category: 'faculty_evaluation',
    formula: 'activity_evaluation_score',
  ...
  },
  {
    ...
    description: 'Percentage of planned unit activities that have been completed.',
    category: 'faculty_evaluation',
    formula: 'activity_completion_rate',
