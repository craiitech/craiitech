                        ...
                        <div key={field.id} className="relative p-5 rounded-2xl border bg-muted/10 space-y-4 group hover:border-primary/30 transition-all">
                            ...
                            <FormField control={control} name={`ched.rqatVisits.${index}.reportLink`} render={({ field: inputField }) => (
                                <FormItem>
                                    ...
                                    <FormControl><Input {...inputField} value={inputField.value || ''} placeholder="https://drive.google.com/..." className="h-9 text-xs bg-white" disabled={!canEdit || !isAdmin} /></FormControl>
                                </FormItem>
                            )} />
