        ...
        <Card className="shadow-md border-primary/10 overflow-hidden bg-card">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
                  Year-over-year document submission completion by cycle — missing rates highlight areas needing
                  improvement
                </CardDescription>
              </div>
            </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-slate-50/50 dark:bg-slate-800/20">
                    ...
                    <TableHead className="text-[9pxpx] font-black uppercase text-slate-500 tracking-wider min-w-[180px]">
                      Document Type
                    </TableHead>
                    ...
                    return (
                      ...
                      >
                        <TableCell className="pl-6 py-3 text-left">
                          <span
                            className={cn('font-black', isTotal ? 'text-sm text-primary' : 'text-xs text-slate-900')}
                          >
                            AY {row.year}
                          </span>
                        </TableCell>
                        ...
                        <TableCell className="tabular-nums font-black text-sm text-slate-700">
                          {row.submitted}
                        </TableCell>
                        ...
                        <TableCell className="tabular-nums">
                          <span
                            className={cn('font-black text-sm', row.missing > 0 ? 'text-rose-600' : 'text-emerald-600')}
                          >
                            {row.missing}
                          </span>
                        </TableCell>
          ...
          <CardFooter className="bg-muted/5 border-t py-2.5 px-6">
            <div className="flex items-center gap-2 text-[9px] text-muted-foreground">
              ...
              Missing = units without a submission for that document type. Completion % = submitted / total units. Gap %
              = missing / total units.
            </div>
          </CardFooter>
        </Card>
