  ...
  return (
    <div className="p-8 text-black bg-white max-w-4xl mx-auto font-sans leading-tight shadow-none border-none">
      ...
      <div className="grid grid-cols-2 gap-y-2 text-sm mb-8">
        ...
        <div><span className="font-bold">ROOM TYPE:</span> {record.roomType || 'Office'}</div>
      ...
      {/* Printing Footer */}
      <div className="mt-16 text-[9px] text-gray-400 italic text-center border-t pt-4 space-y-1">
        <p>This document is an official record generated by the RSU EOMS Portal on {format(new Date(), 'PPpp')}.</p>
        <p className="font-bold">This is a system-generated report; signature is not required.</p>
      </div>
    </div>
  );
}
