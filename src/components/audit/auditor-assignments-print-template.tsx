...
export function AuditorAssignmentsPrintTemplate({ auditorData, year, qaoDirector }: AuditorAssignmentsPrintTemplateProps) {
  ...
  return (
    <div className="text-black bg-white max-w-[8.5in] mx-auto font-sans text-[10px] leading-tight border-none">
      {auditorData.map((auditor, idx) => (
        <div key={idx} className="print-page-break p-8 mb-12 min-h-screen flex flex-col">
          {/* repeated institutional header */}
          ...
          {/* Official Signatories repeated for each auditor */}
          ...
          {/* Footer repeated */}
          <div className="mt-auto pt-4 border-t border-slate-200 flex justify-between items-center text-[8px] text-slate-400 italic uppercase tracking-widest">
