      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-rose-50 border-rose-100 shadow-sm flex flex-col">
          <CardHeader className="pb-2 pt-5 px-6">
            <CardTitle className="text-[10px] font-black uppercase text-rose-700 tracking-widest">
              Total NC Findings
            </CardTitle>
          </CardHeader>
          <CardContent className="px-6 pb-5">
            <div className="text-3xl font-black text-rose-600 tabular-nums">{stats.total}</div>
          </CardContent>
        </Card>
        <Card className="bg-indigo-50 border-indigo-100 shadow-sm flex flex-col">
          <CardHeader className="pb-2 pt-5 px-6">
            <CardTitle className="text-[10px] font-black uppercase text-indigo-700 tracking-widest">
              CARs Formalized
            </CardTitle>
          </CardHeader>
          <CardContent className="px-6 pb-5">
            <div className="text-3xl font-black text-indigo-600 tabular-nums">{stats.issued}</div>
          </CardContent>
        </Card>
        <Card className="bg-amber-50 border-amber-100 shadow-sm flex flex-col">
          <CardHeader className="pb-2 pt-5 px-6">
            <CardTitle className="text-[10px] font-black uppercase text-amber-700 tracking-widest">
              Issuance Pending
            </CardTitle>
          </CardHeader>
          <CardContent className="px-6 pb-5">
            <div className="text-3xl font-black text-amber-600 tabular-nums">{stats.pending}</div>
          </CardContent>
        </Card>
        <Card className="bg-emerald-50 border-emerald-100 shadow-sm flex flex-col">
          <CardHeader className="pb-2 pt-5 px-6">
            <CardTitle className="text-[10px] font-black uppercase text-emerald-700 tracking-widest">
              Issuance Velocity
            </CardTitle>
          </CardHeader>
          <CardContent className="px-6 pb-5">
            <div className="text-3xl font-black text-emerald-600 tabular-nums">{stats.closureRate}%</div>
          </CardContent>
        </Card>
      </div>
        ...
        <CardFooter className="bg-muted/5 border-t py-3 px-8">
          <div className="flex items-start gap-4">
            ...
            <p className="text-[9px] text-muted-foreground leading-relaxed italic">
              <strong>Auditor Guideline:</strong> All Non-Conformance (NC) findings must result in an official
              Corrective Action Request (CAR). This bridge ensures no audit gaps are missed in the institutional quality
              cycle.
            </p>
          </div>
        </CardFooter>
