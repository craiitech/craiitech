      ...
      >
        ...
        >
          <div
            ...
            variant === "floating" ? "rounded-lg border border-sidebar-border shadow" : side === "left" ? "border-r border-sidebar-border" : "border-l border-sidebar-border"
            )}
          >
            {children}
          </div>
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Stable width for skeleton to prevent hydration mismatch.
  const width = "70%";
