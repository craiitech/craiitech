...
const STATUS_GRADIENTS: Record<string, string> = {
  Open: 'url(#car3d-grad-rose)',
  'In Progress': 'url(#car3d-grad-amber)',
  'Awaiting Response/Update': 'url(#car3d-grad-amber)',
  'For Final Verification': 'url(#car3d-grad-indigo)',
  Closed: 'url(#car3d-grad-emerald)',
};
...
const NATURE_GRADIENTS: Record<string, string> = {
  NC: 'url(#car3d-grad-rose)',
  OFI: 'url(#car3d-grad-amber)',
};
...
export function CorrectiveActionsTab({ cars, allUnits, campuses, selectedYear }: CorrectiveActionsTabProps) {
  ...
  const correctiveActionInsights = useMemo(() => {
    ...
    const intermediateCount =
      (agingData.find((d) => d.name === '31–60 days')?.value || 0) +
      (agingData.find((d) => d.name === '61–90 days')?.value || 0);
  ...
  return (
    <div className="space-y-6">
      ...
      <Chart3DDefs idPrefix="car3d" />

      {/* KPI Cards */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          {
            label: 'Total Open CARs',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="shadow-lg hover:shadow-xl transition-all rounded-2xl bg-white dark:bg-slate-900 border-primary/10">
          <CardHeader className="border-b bg-muted/20 pb-3">
            <CardTitle className="text-sm font-black uppercase tracking-wider">CAR Pipeline Status (3D)</CardTitle>
                  ...
                  <PieChart>
                    ...
                    >
                      {statusData.map((entry) => (
                        <Cell
                          key={entry.name}
                          fill={STATUS_GRADIENTS[entry.name] || STATUS_COLORS[entry.name] || '#94a3b8'}
                          filter="url(#car3d-soft-depth)"
                        />
                      ))}
                    </Pie>
                    <RechartsTooltip />
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 rounded-xl p-3 flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-[11px] font-bold text-slate-600 dark:text-slate-400 mt-0.5 leading-relaxed">
                  {correctiveActionInsights.pipelineText}
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <div className="space-y-4">
          ...
          <Card className="shadow-lg hover:shadow-xl transition-all rounded-2xl bg-white dark:bg-slate-900 border-primary/10">
            <CardHeader className="border-b bg-muted/20 pb-3">
              <CardTitle className="text-sm font-black uppercase tracking-wider">NC vs OFI Split (3D)</CardTitle>
              <CardDescription className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
                  ...
                  <PieChart>
                    ...
                    >
                      {natureData.map((entry) => (
                        <Cell
                          key={entry.name}
                          fill={NATURE_GRADIENTS[entry.name] || NATURE_COLORS[entry.name] || '#94a3b8'}
                          filter="url(#car3d-soft-depth)"
                        />
                      ))}
                    </Pie>
              ...
              <div className="mt-3 pt-3 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 rounded-xl p-2.5 flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold text-slate-600 dark:text-slate-400 mt-0.5 leading-relaxed">
                    {correctiveActionInsights.natureText}
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="shadow-lg hover:shadow-xl transition-all rounded-2xl bg-white dark:bg-slate-900 border-primary/10">
            <CardHeader className="border-b bg-muted/20 pb-3">
              <CardTitle className="text-sm font-black uppercase tracking-wider">CARs by Source (3D)</CardTitle>
              <CardDescription className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
            ...
            <CardContent className="pt-4">
              <ResponsiveContainer width="100%" height={120}>
                <BarChart data={sourceData} layout="vertical" margin={{ top: 0, right: 35, left: 10, bottom: 0 }}>
                  ...
                  />
                  <RechartsTooltip />
                  <Bar dataKey="value" name="CARs" radius={[0, 6, 6, 0]} filter="url(#car3d-soft-depth)">
                    {sourceData.map((_, i) => (
                      <Cell
                        key={i}
                        fill={
                          [
                            'url(#car3d-grad-indigo)',
                            'url(#car3d-grad-amber)',
                            'url(#car3d-grad-emerald)',
                            'url(#car3d-grad-sky)',
                          ][i % 4]
                        }
                      />
              ...
              <div className="mt-3 pt-3 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 rounded-xl p-2.5 flex items-start gap-2">
                ...
                <div>
                  <p className="text-[9px] font-black uppercase text-slate-400 tracking-wider">Analysis</p>
                  <p className="text-[10px] font-bold text-slate-600 dark:text-slate-400 mt-0.5 leading-relaxed">
                    {correctiveActionInsights.sourceText}
                  </p>
                </div>
              </div>
            </CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="shadow-lg hover:shadow-xl transition-all rounded-2xl bg-white dark:bg-slate-900 border-primary/10">
          <CardHeader className="border-b bg-muted/20 pb-3">
            <div className="flex items-start justify-between">
              ...
              {agingData.find((d) => d.name === '90+ days')?.value ? (
                <Badge variant="destructive" className="text-[8px] font-black uppercase shrink-0 shadow-sm">
          ...
          <CardContent className="pt-6">
            <ResponsiveContainer width="100%" height={210}>
              <BarChart data={agingData} margin={{ top: 20, right: 20, left: 0, bottom: 0 }}>
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 rounded-xl p-3 flex items-start gap-2">
              ...
              <div>
                <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Analysis & Action Plan</p>
                <p className="text-[11px] font-bold text-slate-600 dark:text-slate-400 mt-0.5 leading-relaxed">
                  {correctiveActionInsights.agingText}
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-all rounded-2xl bg-white dark:bg-slate-900 border-primary/10">
          <CardHeader className="border-b bg-muted/20 pb-3">
            <CardTitle className="text-sm font-black uppercase tracking-wider">Top Units by Open CARs (3D)</CardTitle>
            <CardDescription className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
          ...
          <CardContent className="pt-6">
            {topUnits.length > 0 ? (
              <>
                <ResponsiveContainer width="100%" height={210}>
                  <BarChart data={topUnits} layout="vertical" margin={{ top: 0, right: 35, left: 10, bottom: 0 }}>
                    ...
                    />
                    <RechartsTooltip content={<CustomTooltip />} />
                    <Bar dataKey="open" name="Open CARs" radius={[0, 6, 6, 0]} filter="url(#car3d-soft-depth)">
                      {topUnits.map((entry, i) => (
                        <Cell key={i} fill={entry.nc > 0 ? 'url(#car3d-grad-rose)' : 'url(#car3d-grad-indigo)'} />
                      ))}
                      <LabelList content={<RenderBar3DLabel />} />
                    </Bar>
                  </BarChart>
                ...
                <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 rounded-xl p-3 flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] font-bold text-slate-600 dark:text-slate-400 mt-0.5 leading-relaxed">
                      {correctiveActionInsights.unitsText}
                    </p>
                  </div>
                </div>
              </>
      ...
      <Card className="shadow-lg hover:shadow-xl transition-all rounded-2xl bg-white dark:bg-slate-900 border-primary/10">
        <CardHeader className="border-b bg-muted/20 pb-3">
          <CardTitle className="text-sm font-black uppercase tracking-wider">
            Monthly CAR Trend (3D) — AY {selectedYear}
          </CardTitle>
          <CardDescription className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
            CARs created vs CARs closed per month — a widening gap (red above green) signals the system is falling
            behind
          </CardDescription>
        </CardHeader>
        <CardContent className="pt-6">
          <ResponsiveContainer width="100%" height={220}>
            <LineChart data={monthlyTrend} margin={{ top: 15, right: 30, left: 0, bottom: 5 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="#f1f5f9" opacity={0.15} />
          ...
          <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 rounded-xl p-3 flex items-start gap-2">
            ...
            <div>
              <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Analysis & Action Plan</p>
              <p className="text-[11px] font-bold text-slate-600 dark:text-slate-400 mt-0.5 leading-relaxed">
                {correctiveActionInsights.trendText}
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="shadow-lg hover:shadow-xl transition-all rounded-2xl bg-white dark:bg-slate-900 border-primary/10">
        <CardHeader className="border-b bg-muted/20 pb-3">
          <CardTitle className="text-sm font-black uppercase tracking-wider">
            Corrective Actions by Campus (3D Stacked)
          </CardTitle>
          <CardDescription className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
        ...
        <CardContent className="pt-6">
          <ResponsiveContainer width="100%" height={230}>
            <BarChart data={byCampus} margin={{ top: 15, right: 20, left: 0, bottom: 35 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="#f1f5f9" opacity={0.15} />
              ...
              {Object.entries(STATUS_COLORS).map(([status, color]) => (
                <Bar
                  ...
                  dataKey={status}
                  stackId="a"
                  fill={STATUS_GRADIENTS[status] || color}
                  filter="url(#car3d-soft-depth)"
                >
                  <LabelList
                    dataKey={status}
          ...
          <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 rounded-xl p-3 flex items-start gap-2">
            ...
            <div>
              <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider">Analysis & Action Plan</p>
              <p className="text-[11px] font-bold text-slate-600 dark:text-slate-400 mt-0.5 leading-relaxed">
                {correctiveActionInsights.campusText}
              </p>
            </div>
          </div>
        </CardContent>
