...
export function RiskOverdueWarning({ risks, isLoading }: RiskOverdueWarningProps) {
  ...
  return (
    <div className="space-y-4">
      <Alert
        variant="destructive"
        className="relative overflow-hidden animate-warning-banner border-destructive/50 transition-all shadow-md duration-500 animate-in slide-in-from-top-2"
      >
        ...
        <AlertTitle className="relative z-10 font-black uppercase tracking-tight text-destructive">
          Urgent: Risk Treatment Overdue
        </AlertTitle>
        <AlertDescription className="space-y-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-2">
            <span className="text-sm font-bold text-slate-800 dark:text-slate-200">
              <strong className="text-destructive">{overdueCount}</strong> Risk Treatment(s) have passed their target
              implementation date. Please update the <strong>Final Assessment</strong> immediately to maintain audit
              compliance.
            </span>
            <div className="flex items-center gap-2 shrink-0">
              ...
              <Button
                ...
                variant="destructive"
                asChild
                className="h-9 px-6 font-black uppercase text-[10px] tracking-widest shadow-lg shadow-destructive/20"
              >
              ...
              <div className="mt-4 p-5 rounded-2xl border-2 border-destructive/20 bg-white space-y-4 shadow-inner">
                <div className="flex items-center gap-2 text-destructive">
                  ...
                  <h4 className="text-[10px] font-black uppercase tracking-widest">
                    Protocol: Resolution of Overdue Risks
                  </h4>
                </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[10px] text-slate-600 dark:text-slate-400 leading-relaxed font-medium italic">
                          Confirm that your unit has already <strong>taken action</strong> on the Risk and that the
                          implementation is fully documented with evidence.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[10px] text-slate-600 dark:text-slate-400 leading-relaxed font-medium italic">
                          Locate and select the specific <strong>Risk or Opportunity</strong> from your unit list that
                          requires the update.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[10px] text-slate-900 dark:text-slate-100 leading-relaxed font-bold">
                          Provide the necessary updates in <strong>Section #4 (Final Assessment)</strong> based on your
                          actual ROR documents and actions.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-4 bg-amber-50 rounded-xl border border-amber-100 flex items-start gap-3">
                  ...
                  <p className="text-[10px] text-amber-800 font-medium italic">
                    <strong>Note:</strong> Closing the risk digitally is a prerequisite for achieving full maturity
                    index status in the institutional dashboard.
                  </p>
                </div>
              </div>
            </CollapsibleContent>
