...
export function CARPrintTemplate({
  ...
  return (
    <div
      className="p-0 text-black dark:text-white bg-white mx-auto font-sans leading-tight border-none"
      style={{ width: '7.5in', fontSize: '11pt' }}
    >
      {/* Header - Centered without logo */}
      <div className="text-center mb-4">
        <div className="flex flex-col items-center justify-center gap-1 mb-2">
          <h1 className="font-bold uppercase" style={{ fontSize: '12pt' }}>
        ...
        <div className="mt-4 border-y-2 border-black py-1.5 bg-slate-50 dark:bg-slate-800/50">
          <h2 className="font-black uppercase tracking-[0.2em]" style={{ fontSize: '12pt' }}>
      ...
      <div className="w-full border-2 border-black border-b-0">
        <div className="grid grid-cols-12">
            ...
            <div className="space-y-1 pl-2" style={{ fontSize: '10pt' }}>
              {['Audit Finding', 'Legal Non-compliance', 'Non-conforming Service', 'Others'].map((s) => (
                <div key={s} className="flex items-center gap-2">
                  <div
                    className={cn(
                      'w-3 h-3 border border-black flex items-center justify-center',
                      car.source === s && 'bg-black',
                    )}
                  >
          ...
          <div className="col-span-5 border-r border-black p-2">
            <p className="font-bold" style={{ fontSize: '10pt' }}>
              Title: <span className="font-normal">(Title of Procedure)</span>
            </p>
            <p className="mt-2 font-bold uppercase" style={{ fontSize: '11pt' }}>
              {car.procedureTitle}
            </p>
          </div>
          <div className="col-span-3 p-2">
            ...
            <p className="mt-2 font-mono" style={{ fontSize: '11pt' }}>
              {car.ncReportNumber || '--'}
            </p>
          </div>
        </div>
            ...
            <div className="flex gap-8 mt-1" style={{ fontSize: '10pt' }}>
              <div className="flex items-center gap-2">
                <div
                  className={cn(
                    'w-3 h-3 border border-black flex items-center justify-center',
                    car.natureOfFinding === 'NC' && 'bg-black',
                  )}
                ></div>
                <span>NC</span>
              </div>
              <div className="flex items-center gap-2">
                <div
                  className={cn(
                    'w-3 h-3 border border-black flex items-center justify-center',
                    car.natureOfFinding === 'OFI' && 'bg-black',
                  )}
                ></div>
                <span>OFI</span>
              </div>
      ...
      <div className="w-full border-2 border-black border-b-0">
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-6 p-2">
            ...
            <p className="font-black" style={{ fontSize: '11pt' }}>
      ...
      <div className="w-full border-2 border-black border-b-0">
        <div className="p-2 min-h-[100px]">
          ...
          <p className="mt-2 whitespace-pre-wrap leading-relaxed italic" style={{ fontSize: '11pt' }}>
      ...
      <div className="w-full border-2 border-black border-b-0 overflow-hidden">
        <div className="grid grid-cols-3 text-center font-bold">
          <div className="border-r border-black p-2">
            <p className="uppercase opacity-60 mb-4" style={{ fontSize: '10pt' }}>
              Request Date
            </p>
            <p className="border-t border-black pt-1" style={{ fontSize: '11pt' }}>
              {safeDate(car.requestDate)}
            </p>
          </div>
          <div className="border-r border-black p-2">
            <p className="uppercase opacity-60 mb-4" style={{ fontSize: '10pt' }}>
            ...
            <p className="border-t border-black pt-1 uppercase" style={{ fontSize: '11pt' }}>
              {car.preparedBy}
            </p>
          </div>
          <div className="p-2">
      ...
      <div className="w-full border-2 border-black border-b-0">
        <div className="p-2 min-h-[100px]">
          ...
          <p className="mt-2 whitespace-pre-wrap leading-relaxed" style={{ fontSize: '11pt' }}>
            {car.rootCauseAnalysis || 'Awaiting Investigation...'}
          </p>
        </div>
      </div>
      ...
      <div className="w-full border-2 border-black border-b-0">
        <div className="grid grid-cols-12 min-h-[120px]">
          ...
          <div className="col-span-3">
            ...
            <div
              className="p-2 text-center font-bold flex flex-col items-center justify-center h-[calc(100%-2rem)]"
              style={{ fontSize: '11pt' }}
            >
      ...
      <div className="w-full border-2 border-black border-b-0">
        <div className="grid grid-cols-2 text-center">
          <div className="border-r border-black p-4">
            <p className="font-bold uppercase mb-6" style={{ fontSize: '10pt' }}>
              Responsible Unit
            </p>
            <p className="border-t border-black pt-1 font-bold" style={{ fontSize: '11pt' }}>
              {unitName}
            </p>
          </div>
          <div className="p-4">
      ...
      <div className="w-full border-2 border-black border-b-0">
        <div className="grid grid-cols-12 min-h-[100px]">
          <div className="col-span-9 border-r border-black p-2">
            <p className="font-bold" style={{ fontSize: '10pt' }}>
              III. Follow up result of the Correction and Corrective Action
            </p>
            <p className="mt-2 italic" style={{ fontSize: '11pt' }}>
              {latestFollowUp?.result || '--'}
            </p>
            {latestFollowUp?.nextAction && (
              <div className="mt-3 pt-2 border-t border-dashed border-black/40 text-[9pt]">
                <span className="font-bold uppercase text-primary">Scheduled Next Action:</span>{' '}
                <span className="font-semibold">{latestFollowUp.nextAction}</span>
                {latestFollowUp.nextActionDate && (
                  <span className="ml-2 font-normal">
                    (Validation Date: <strong>{safeDate(latestFollowUp.nextActionDate)}</strong>)
                  </span>
                )}
              </div>
            )}
      ...
      <div className="w-full border-2 border-black border-b-0">
        <div className="grid grid-cols-12 min-h-[100px]">
          <div className="col-span-9 border-r border-black p-2">
            <p className="font-bold" style={{ fontSize: '10pt' }}>
              IV. Verification of Effectiveness of the action taken:
            </p>
            <p className="mt-2 italic" style={{ fontSize: '11pt' }}>
              {latestEffectiveness?.result || '--'}
            </p>
            {latestEffectiveness?.action && (
              <p className="mt-4 font-black uppercase text-primary" style={{ fontSize: '12pt' }}>
                DETERMINATION: {latestEffectiveness.action}
              </p>
            )}
          </div>
          <div className="col-span-3 p-2">
