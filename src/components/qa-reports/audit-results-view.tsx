...
export function AuditResultsView({
  ...
  const kpis = useMemo(() => {
    ...
    const complianceRate =
      totalFindings > 0
        ? Math.round(
            (filteredFindings.filter((f) => f.type === 'Compliance').length /
              (totalFindings - filteredFindings.filter((f) => f.type === 'Not Applicable').length || 1)) *
              100,
          )
        : 0;
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-rose-50 border-rose-100 shadow-sm flex flex-col">
          <CardHeader className="pb-2 pt-5 px-6">
            <CardTitle className="text-[10px] font-black uppercase text-rose-700">Critical Gaps (NC)</CardTitle>
          </CardHeader>
          <CardContent className="px-6 pb-5">
        ...
        <Card className="bg-amber-50 border-amber-100 shadow-sm flex flex-col">
          <CardHeader className="pb-2 pt-5 px-6">
            <CardTitle className="text-[10px] font-black uppercase text-amber-700">OFI Observations</CardTitle>
          </CardHeader>
          <CardContent className="px-6 pb-5">
        ...
        <Card className="bg-indigo-50 border-indigo-100 shadow-sm flex flex-col">
          <CardHeader className="pb-2 pt-5 px-6">
            <CardTitle className="text-[10px] font-black uppercase text-indigo-700">CAR Transition</CardTitle>
          </CardHeader>
          <CardContent className="px-6 pb-5">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="bg-muted p-1 border shadow-sm w-fit h-10">
          ...
          <TabsTrigger
            ...
            className="gap-2 text-[10px] font-black uppercase tracking-widest px-6 h-8 data-[state=active]:bg-rose-600 data-[state=active]:text-white"
          >
            ...
            <CardHeader className="bg-emerald-50 border-b py-4">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-sm font-black uppercase tracking-tight">
                  Institutional Commendable Practices Registry
                </CardTitle>
              </div>
            </CardHeader>
            <CardContent className="p-0">
              <Table>
                <TableHeader className="bg-muted/30">
                  <TableRow>
                    <TableHead className="pl-8 py-3 text-[10px] font-black uppercase">Source Unit</TableHead>
                    <TableHead className="text-[10px] font-black uppercase">Auditor Commendation</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  ...
                  {commendableRegistry.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={2} className="h-40 text-center opacity-20">
                        ...
                        <p className="text-[10px] font-black uppercase">No commendable findings logged</p>
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
          ...
          <Card className="shadow-md border-primary/10 overflow-hidden">
            <CardHeader className="bg-amber-50 border-b py-4">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-sm font-black uppercase tracking-tight text-amber-900">
            ...
            <CardContent className="p-0">
              <Table>
                <TableHeader className="bg-muted/30">
                  <TableRow>
                    <TableHead className="pl-8 py-3 text-[10px] font-black uppercase">Source Unit</TableHead>
                    <TableHead className="text-[10px] font-black uppercase">OFI Finding / Recommendation</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {ofiRegistry.map((s) => {
                  ...
                  {ofiRegistry.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={2} className="h-40 text-center opacity-20">
                        ...
                        <p className="text-[10px] font-black uppercase">No OFIs recorded</p>
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
            ...
            <CardHeader className="bg-rose-50 border-b py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-sm font-black uppercase tracking-tight text-rose-900">
                    Institutional Non-Conformance (NC) Registry
                  </CardTitle>
                </div>
                <Badge variant="destructive" className="h-5 text-[9px] font-black">
                  {ncRegistry.length} GAPS
                </Badge>
              </div>
            </CardHeader>
            <CardContent className="p-0">
