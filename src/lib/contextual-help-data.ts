...
export const helpContent: Record<string, PageHelp> = {
    ...
    steps: [
      {
        ...
        desc: 'Read the Communications Board for site-specific directives from your Director.',
      },
      {
        title: 'Monitor Maturity',
        desc: "View your unit's compliance percentage. High percentage indicates all mandatory docs are verified.",
      },
      {
        title: 'Review Alerts',
        desc: 'Address any red "Action Required" cards immediately to avoid non-compliance flags.',
      },
    ],
    buttons: [
  ...
  '/dashboard?tab=overview': {
    ...
    steps: [
      {
        title: 'EOMS Health Index',
        desc: 'Monitor the composite quality score and its dynamic quality insights/bottlenecks.',
      },
      {
        title: 'Campus/Dept Standings',
        desc: 'Compare verified EOMS submission compliance across physical sites or departments.',
      },
      {
        title: 'Strategic SWOT',
        desc: 'Analyze derived institutional Strengths and Weaknesses right below the scores.',
      },
      {
        title: 'Pillars & Bottlenecks',
        desc: 'Review individual QMS pillar scores and address high-priority alert cards.',
      },
    ],
    buttons: [
      {
        label: 'View Year',
        labelShort: 'Year',
        action: 'Filters all dashboard metrics and trends to the selected year.',
      },
  ...
  '/dashboard?tab=analytics': {
    ...
    buttons: [{ label: 'Risk Rating', labelShort: 'Risk', action: 'Categorization of threats by Magnitude.' }],
  },
  '/dashboard?tab=strategic': {
    ...
    buttons: [{ label: 'Maturity Radar', labelShort: 'Radar', action: 'Visual map of quality assurance balance.' }],
  },
  ...
  '/dashboard?tab=risk-opportunity': {
    ...
    steps: [
      {
        title: 'Risk Control Index',
        desc: 'Track the ratio of mitigated and closed risk registers for the current year.',
      },
      {
        title: 'Pre/Post Treatment',
        desc: 'Verify that residual risk rankings have successfully decreased to low levels.',
      },
      {
        title: 'Strategic Register',
        desc: 'Review the master table of active threats to prioritize mitigation efforts.',
      },
    ],
    buttons: [
    ...
    steps: [
      {
        ...
        desc: 'Review status breakdowns (Open, Awaiting Response, For Verification, Closed).',
      },
      { title: 'Aging & Overdue', desc: 'Identify critical open CARs exceeding the 90-day QMS verification limit.' },
      {
        title: 'Top Units Workload',
        desc: 'Track departments with the highest corrective action burden to allocate assistance.',
      },
    ],
    buttons: [
      {
        label: 'Print CARs',
        labelShort: 'Print',
        action: 'Generates the consolidated corrective action register report.',
      },
    ],
  },
  '/dashboard?tab=actionable-decisions': {
    ...
    steps: [
      ...
      {
        title: 'Timeline Triage',
        desc: 'Identify pending review decisions that are past their target resolution dates.',
      },
  ...
  '/dashboard?tab=actions': {
    ...
    buttons: [{ label: 'Manage Submissions', labelShort: 'Pencil', action: 'Enters the document submission wizard.' }],
  },
  ...
  '/gad-corner': {
    ...
    steps: [
      { title: 'Select Context', desc: 'Use the "Fiscal Year" and "Unit" filters to scope your data view.' },
      {
        ...
        desc: 'Navigate between the PAP, SDD, and Mainstreaming tabs to manage different GAD pillars.',
      },
    ],
    buttons: [
  ...
  '/gad-corner?tab=overview': {
    ...
    steps: [
      {
        title: 'Budget Pulse',
        desc: 'Monitor the utilization rate to ensure funds are being spent as planned in the GPB.',
      },
      {
        title: 'Sectoral Mix',
        desc: 'Review the "Student Sectoral Reach" chart to identify marginalized group representation.',
      },
    ],
    buttons: [{ label: 'Utilization', labelShort: 'Rate', action: 'Percentage of allocated GAD budget expended.' }],
  },
  '/gad-corner?tab=activities': {
    ...
    buttons: [{ label: 'Log Event', labelShort: 'Log', action: 'Opens the internal SDD entry form.' }],
  ...
  '/gad-corner?tab=gpb': {
    ...
    steps: [
      ...
      { title: 'Define PAP', desc: 'Describe the Program, Activity, or Project designed to mitigate the issue.' },
      {
        ...
        desc: 'Assign fiscal resources. The system will check against the 5% institutional mandate.',
      },
    ],
    buttons: [
  ...
  '/gad-corner?tab=ar': {
    ...
    steps: [
      { title: 'Verify Sync', desc: 'The system automatically pulls participant data from the Event Registry.' },
      {
        ...
        desc: 'Review budget variances and provide justifications for any deviations from the GPB.',
      },
  ...
  '/gad-corner?tab=sdd': {
    ...
    steps: [
      {
        title: 'Personnel Census',
        desc: 'Unit Heads: Update your office headcount by sex and sector for the current year.',
      },
      { title: 'Student Baseline', desc: 'Review automated roll-ups of student data from program compliance logs.' },
    ],
    buttons: [{ label: 'Commit Census', labelShort: 'Save', action: "Saves your unit's employee headcount registry." }],
  },
    ...
    steps: [
      {
        ...
        desc: 'Review the 8 core PCW mainstreaming elements across Policy, Facility, and Data.',
      },
      {
        title: 'Self-Assessment',
        desc: 'Click the item card to toggle its status once your unit has implemented the requirement.',
      },
      {
        title: 'Audit Verification',
        desc: 'Admins will verify these self-assessments during the field monitoring visits.',
      },
    ],
    buttons: [
      {
        ...
        labelShort: '%',
        action: 'A calculated percentage of implemented mainstreaming criteria.',
      },
    ],
  },
  ...
  '/monitoring?tab=performance': {
    ...
    steps: [
      {
        title: 'Review Gaps',
        desc: 'Identify which monitoring items (e.g. ARTA signages) have the most non-conformities.',
      },
      { title: 'Benchmark Sites', desc: 'Compare compliance scores between different campuses and units.' },
    ],
    buttons: [{ label: 'Export', labelShort: 'XLSX', action: 'Downloads the monitoring raw data to Excel.' }],
  },
  '/monitoring?tab=history': {
    ...
    buttons: [{ label: 'Edit', labelShort: 'Edit', action: 'Admins can modify past logs if corrections are needed.' }],
  },
  '/monitoring?tab=findings': {
    ...
    buttons: [{ label: 'Findings', labelShort: 'Gaps', action: 'Total count of units currently flagged.' }],
  },
  ...
  '/academic-programs?tab=batch-hub': {
    ...
    steps: [
      { title: 'Select Mode', desc: 'Choose between Enrollment, Graduation, Board Exam, or Tracer data.' },
      {
        ...
        desc: 'Click "Start Log" to update metrics for a specific program for the selected year.',
      },
    ],
    buttons: [
  ...
  '/submissions': {
    ...
    steps: [
      {
        title: 'Identify Cycle',
        desc: 'Determine if you are submitting for the First or Final cycle based on the university calendar.',
      },
      { title: 'New Submission', desc: 'Click the button and select the specific report type (e.g., SWOT, Op Plan).' },
      {
        title: 'Select Version',
        desc: 'Choose "Draft" for content checking or "Final" for signed institutional records.',
      },
    ],
    buttons: [
      { label: 'New Submission', labelShort: 'New', action: 'Starts the multi-step document upload wizard.' },
      {
        ...
        labelShort: 'Templates',
        action: 'Accesses the official RSU GDrive for standardized forms.',
      },
    ],
  },
  '/submissions/new': {
    ...
    alert:
      'FINAL ROR NOTICE: Final Cycle submissions for the Risk & Opportunity Registry will be BLOCKED unless all digital entries for the year are updated with a Post-Treatment analysis.',
    steps: [
      {
        title: 'Link Validation',
        desc: 'Paste the GDrive link. The system will automatically check if the Quality Assurance Office has access.',
      },
      {
        title: 'Compliance Checklist',
        desc: 'Final versions require manual confirmation of Year, Cycle, and Signatures.',
      },
      {
        title: 'Revision Control',
        desc: 'Re-uploading for the same year/cycle will automatically increment the Revision (Rev 00, 01, etc.).',
      },
    ],
    buttons: [
      {
        label: 'How to get link?',
        labelShort: 'Help',
        action: 'Displays the 7-step guide for correct Google Drive sharing.',
      },
    ],
  },
  ...
  '/risk-register': {
    ...
    alert:
      "ODIMO NOTICE: Only the Unit Coordinator is authorized to input data to this digital Registry. This ensures coordinators maintain full ownership and awareness of their unit's identified risks.",
    steps: [
      {
        title: 'Step 1: Identify Factor',
        desc: 'Select Risk (Threat) or Opportunity (Gain) and describe the process objective.',
      },
      {
        title: 'Step 2: Initial Analysis',
        desc: 'Rate Likelihood and Consequence. Ratings of 5-25 trigger a mandatory Action Plan requirement.',
      },
      {
        title: 'Step 3: Treatment Action',
        desc: 'Provide an actionable mitigation strategy. Use the "AI Suggest" button for professional ISO-aligned advice.',
      },
      {
        title: 'Step 4: Post-Treatment Audit',
        desc: 'DURING FINAL CYCLE: Update the "Residual Likelihood/Consequence" based on your actual implementation evidence.',
      },
    ],
    buttons: [
      { label: 'Log New Entry', labelShort: 'Log', action: 'Starts the risk identification and analysis form.' },
      {
        label: 'AI Suggest',
        labelShort: 'AI',
        action: 'Generates professional mitigation strategies based on your description.',
      },
      { label: 'Apply & Sync', labelShort: 'Save', action: 'Commits your analysis to the institutional database.' },
    ],
    nextStep:
      'Final Cycle ROR documents cannot be submitted until all digital entries here are updated with Section 4 (Post-Treatment).',
  },
  ...
  '/unit-forms': {
    ...
    steps: [
      { title: 'Access Roster', desc: 'Click "Access Official Roster" to view your unit\'s approved form library.' },
      {
        ...
        desc: 'Check the Masterlist PDF preview to confirm currently registered form versions.',
      },
    ],
    buttons: [
      {
        label: 'Apply for Form',
        labelShort: 'Register',
        action: 'Starts the DRF process to enroll new or revised forms.',
      },
    ],
  },
  '/unit-forms?tab=roster': {
    ...
    steps: [
      { title: 'Search Forms', desc: 'Find forms by code (e.g. QAO-01) or official title.' },
      {
        ...
        desc: 'Logging is mandatory for downloads to maintain the audit trail of form utilization.',
      },
    ],
    buttons: [
      {
        label: 'Link Authorized',
        labelShort: 'Auth',
        action: 'Opens the secure download link after logging requester info.',
      },
    ],
  },
  ...
  '/qa-reports': {
    ...
    steps: [
      ...
      {
        title: 'Select Module',
        desc: 'Use the tab navigation to switch between Analytics, Decisions, CARs, or Audit Reports.',
      },
    ],
    buttons: [
  ...
  '/qa-reports?tab=overview': {
    ...
    buttons: [{ label: 'Resolution', labelShort: 'Rate', action: 'Percent of CARs closed vs total issued.' }],
  },
  '/qa-reports?tab=decisions': {
    ...
    steps: [
      ...
      {
        title: 'Update Status',
        desc: 'Click "Update" to record action taken, attach evidence, and move items toward closure.',
      },
    ],
    buttons: [{ label: 'Update', labelShort: 'Log', action: 'Opens the decision implementation tracking form.' }],
  },
  '/qa-reports?tab=car': {
    ...
    steps: [
      {
        title: 'Respond to NC',
        desc: 'Units: If you have an "Open" CAR, click "Manage" to perform root cause analysis.',
      },
      { title: 'Final Verification', desc: 'Admins: Review unit responses and verify effectiveness to close the CAR.' },
    ],
    buttons: [
      {
        label: 'Print Registry',
        labelShort: 'Print',
        action: 'Generates the official CAR Control Register (QAO-00-019).',
      },
  ...
  '/qa-reports?tab=iqa': {
    ...
    steps: [
      ...
      {
        title: 'Preview Files',
        desc: 'Use the "Preview" button to view the vaulted PDF evidence directly in the portal.',
      },
    ],
    buttons: [{ label: 'Vault', labelShort: 'Open', action: 'Accesses the institutional IQA document archive.' }],
  },
  '/qa-reports?tab=eqa': {
    ...
    steps: [
      {
        ...
        desc: 'Select a session from the sidebar to view its specific decisions and outputs.',
      },
      { title: 'Open Minutes', desc: 'Click the minutes link to access the signed record of the session proceedings.' },
    ],
    buttons: [{ label: 'New Session', labelShort: 'Add', action: 'Registers a new MR meeting into the system.' }],
  },
    ...
    steps: [
      {
        ...
        desc: 'Use the sub-tabs to switch between standard Office work and remote WFH sheets.',
      },
      {
        title: 'Log Activity',
        desc: 'Click the primary action button to record a new task with its corresponding output.',
      },
      {
        title: 'Verify Records',
        desc: 'Heads: Use the "Verify" buttons to authenticate unit accomplishments for the month.',
      },
    ],
    buttons: [
    ...
    steps: [
      {
        ...
        desc: 'Review high-level analytics and finding distribution for the selected year.',
      },
      {
        title: 'Manage Itinerary',
        desc: 'Switch to the "Registry" tab to provision unit sessions and assign auditors.',
      },
    ],
    buttons: [
  ...
  '/audit?tab=analytics': {
    ...
    steps: [
      {
        title: 'Monitor Gaps',
        desc: 'Review the "Unit Finding Hotspots" to identify offices with open non-conformances.',
      },
      {
        title: 'Check Coverage',
        desc: 'Analyze the "Clause Audit Density" to see which ISO requirements are being prioritized.',
      },
    ],
    buttons: [
      {
        label: 'Print Registry',
        labelShort: 'Print',
        action: 'Generates the official Auditor Assignment Registry PDF.',
      },
    ],
  },
  '/audit?tab=registry': {
    ...
    steps: [
      {
        ...
        desc: 'Click "Add Entry" on a plan to schedule a unit session with specific ISO clauses.',
      },
      {
        title: 'Framework Clone',
        desc: 'Use "Clone Plan" to replicate successful audit frameworks across different campuses.',
      },
    ],
    buttons: [
  ...
  '/manuals': {
    ...
    steps: [
      { title: 'Index Search', desc: "Use the sidebar or search bar to find a specific unit's manual." },
      {
        ...
        desc: 'Check the revision badge to ensure you are referencing the latest approved version.',
      },
    ],
    buttons: [{ label: 'Preview', labelShort: 'View', action: 'Loads the PDF preview within the portal.' }],
  },
  '/eoms-policy-manual': {
    ...
    steps: [
      {
        ...
        desc: 'Choose a policy section from the Table of Contents to view its specific standards.',
      },
      {
        title: 'Standard Compliance',
        desc: 'Refer to these sections for guidance on institutional quality requirements.',
      },
    ],
  ...
  '/communications': {
    ...
    description:
      'Central management registry for official digital and physical correspondence, including QA Advisories and directives.',
    steps: [
      {
        title: 'Log or Send',
        desc: 'Log hardcopy documents under the "Manual Registry Log" or dispatch digital alerts using "Direct Digital Send".',
      },
      { title: 'Track Correspondence', desc: 'Browse incoming and outgoing logs to trace official document routes.' },
      {
        title: 'QA Advisories',
        desc: 'Access published QA directives and official communications from the Quality Assurance Office.',
      },
      {
        title: 'Print Logbooks',
        desc: 'Generate high-fidelity, printable RSU-standard logbook formats for physical filing.',
      },
    ],
    buttons: [
      { label: 'Log/Send', labelShort: 'New', action: 'Opens the workspace to register a new communication record.' },
      {
        ...
        labelShort: 'Print',
        action: 'Generates the print-ready incoming correspondence logbook.',
      },
      {
        label: 'Print Outgoing',
        labelShort: 'Print',
        action: 'Generates the print-ready outgoing correspondence logbook.',
      },
    ],
  },
  '/communications?tab=incoming': {
    ...
    description:
      'Register and stamp official correspondences received from other units, campuses, or external agencies.',
    steps: [
      { title: 'Review Alerts', desc: 'Unread or newly received communications display a prominent status indicator.' },
      {
        ...
        desc: 'For digital correspondence marked as "Pending Receipt", click "Receive" to stamp local receiving codes.',
      },
    ...
    buttons: [
      {
        label: 'Receive & Stamp',
        labelShort: 'Recv',
        action: 'Opens the stamp dialog to assign local receipt dates and tracking numbers.',
      },
  ...
  '/communications?tab=outgoing': {
    ...
    description:
      'Track all official correspondences dispatched from your office to academic units, campuses, or individual system recipients.',
    steps: [
      {
        title: 'Recipient Scope',
        desc: 'Verify recipient tags to ensure documents were correctly routed to target departments or individuals.',
      },
      {
        title: 'Origin Trace',
        desc: 'Use original reference codes (Orig. Ref) to audit and trace the document lifecycle.',
      },
      {
        title: 'Registry Log',
        desc: 'Direct digital sends show target departments; manual logs show destination text.',
      },
    ],
    buttons: [
      {
        label: 'Edit Record',
        labelShort: 'Edit',
        action: 'Modifies the metadata, subject, or links of an existing log.',
      },
      {
        label: 'Delete Record',
        labelShort: 'Del',
        action: 'Removes the registry entry from the database (restricted to admin/ODIMO).',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        desc: 'Use the horizontal scrolling tabs to manage Users, Campuses, Units, or Registry Cycles.',
      },
  ...
  '/settings?tab=users': {
    ...
    buttons: [{ label: 'Activate', labelShort: 'Auth', action: 'Grants full portal access to the user.' }],
  },
  '/settings?tab=logo': {
  ...
  '/settings?tab=signatories': {
    ...
    steps: [
      ...
      {
        title: 'Global Update',
        desc: 'Saving here updates signatures across all printed audit and compliance reports.',
      },
    ],
  },
  '/settings?tab=gad': {
    ...
    steps: [
      { title: 'Assign Office', desc: 'Select the primary GAD office responsible for university-wide reporting.' },
      {
        ...
        desc: 'Users in this unit will be granted oversight permissions in the GAD Corner.',
      },
    ],
  },
  ...
  '/settings?tab=cycles': {
    ...
    steps: [
      {
        title: 'Establish Window',
        desc: 'Define the Start, Submission Start, and End (deadline) dates for First and Final cycles.',
      },
  ...
  '/submissions/[id]': {
    ...
    steps: [
      {
        title: 'Review File Revisions',
        desc: 'Browse the uploaded documents under "Audit Trail". Revisions increment automatically (Rev 00, 01, etc.).',
      },
      {
        title: 'Check Feedback & Comments',
        desc: 'View feedback from your campus Director or QA auditors in the discussion thread.',
      },
      {
        title: 'Status Assessment',
        desc: "Verify the document's verification phase: Draft Checked, Approved, or Needs Revision.",
      },
    ],
    buttons: [
      { label: 'View Link', labelShort: 'Open', action: 'Opens the underlying document in Google Drive.' },
      {
        ...
        labelShort: 'Upload',
        action: 'Uploads a replacement revision to clear rejection notes.',
      },
    ],
  },
  ...
  '/audit/[scheduleId]': {
    ...
    steps: [
      { title: 'Verify Details', desc: 'Confirm unit name, scheduled date, and assigned auditor team details.' },
      {
        ...
        desc: 'Review individual ISO clauses. Check off items based on verified physical or digital records.',
      },
      {
        title: 'Record Observations',
        desc: 'Input auditor remarks, recommendations (OFI), or non-conformances (NC) directly under each item.',
      },
      {
        title: 'Sync Registry',
        desc: 'Click "Save Progress" to mirror data. If offline, the portal caches changes locally.',
      },
    ],
    buttons: [
      {
        label: 'Save Draft',
        labelShort: 'Save',
        action: 'Caches current checklist scores without closing the audit session.',
      },
      {
        label: 'Complete Audit',
        labelShort: 'Submit',
        action: 'Locks the checklist and pushes final records to the QA register.',
      },
  ...
  '/audit/cap/[findingId]': {
    ...
    steps: [
      { title: 'Understand Finding', desc: 'Review the details of the non-conformance (NC) recorded by the auditor.' },
      {
        ...
        desc: 'Explain why the breakdown occurred. Use 5-Why analysis to identify institutional gaps.',
      },
      {
        title: 'Formulate Action Plan',
        desc: 'Define correction steps and assign target dates with responsible personnel.',
      },
    ...
    buttons: [
      {
        label: 'Propose CAP',
        labelShort: 'Submit',
        action: 'Submits the corrective actions list for Auditor verification.',
      },
      {
        label: 'Acknowledge',
        labelShort: 'Verify',
        action: 'Auditor: Confirms the proposed actions address the root cause.',
      },
    ],
  },
    ...
    buttons: [
      {
        label: 'Edit Metadata',
        labelShort: 'Edit',
        action: 'Allows coordinators to update program codes or description.',
      },
      {
        label: 'Accreditation',
        labelShort: 'Level',
        action: 'Opens the detail checklist for the current AACCUP profile.',
      },
    ],
  },
  ...
  '/visitor-logbook': {
    ...
    steps: [
      ...
      {
        title: 'Assign Target Office',
        desc: 'Select the destination department. Campus Directors & Odimos use "OFFICE OF THE CAMPUS DIRECTOR".',
      },
    ...
    steps: [
      {
        ...
        desc: 'Rate portal metrics: Functional Suitability, Performance Efficiency, Usability, Security.',
      },
      {
        title: 'Provide Scoring',
        desc: 'Select ratings from 1 (Poor) to 5 (Excellent) based on your operational experience.',
      },
    ...
    buttons: [
      {
        ...
        labelShort: 'Save',
        action: 'Saves your evaluation profile to the central registry.',
      },
    ],
  },
  ...
  '/faculty-evaluation': {
    ...
    steps: [
      { title: 'Staff Index', desc: 'Review the list of faculty members mapped to your academic program.' },
      {
        ...
        desc: "Ensure qualifications (Master's/Doctorate degrees, specialization alignment) are updated.",
      },
  ...
  '/profile': {
    ...
    steps: [
      {
        ...
        desc: 'Update your display name. Institutional roles and office assignments remain locked.',
      },
      {
        title: 'Accessibility Features',
        desc: 'Toggle Dyslexic Font, High Contrast colors, and scaling factors for comfort.',
      },
    ...
    buttons: [
      { label: 'Save Settings', labelShort: 'Save', action: 'Commits accessibility profiles and display updates.' },
      {
        label: 'Danger Zone',
        labelShort: 'Delete',
        action: 'Permits account termination under RA 10173 Right to Erasure.',
      },
    ],
  },
  ...
  '/approvals': {
    ...
    steps: [
      { title: 'Audit Queue', desc: 'View pending files submitted by units under your site or campus jurisdiction.' },
      {
        ...
        desc: 'Open and review EOMS files (SWOT, Risk Registers, OpPlans) for accuracy.',
      },
      {
        title: 'Status Determination',
        desc: 'Mark files as Approved to complete compliance steps, or Reject with corrective notes.',
      },
    ],
    buttons: [
      {
        ...
        labelShort: 'Accept',
        action: 'Saves status as Approved, updating unit maturity metric.',
      },
      {
        label: 'Reject Submission',
        labelShort: 'Return',
        action: 'Sets status to Rejected and requests unit corrections.',
      },
    ],
  },
  ...
  '/unit-activity': {
    ...
    description:
      'Central registry for units to plan activities, upload Google Drive links, configure multi-session attendance schedules, and review analytics.',
    steps: [
      {
        title: 'Register Activity',
        desc: 'Create a new activity with description, dates, target unit, and dynamic sessions.',
      },
      {
        title: 'Attach CSW Documents',
        desc: 'Click the "+" button to link Google Drive files (Proposal, Terminal Report) with text descriptions.',
      },
      {
        title: 'Configure Sessions',
        desc: 'Define individual sessions (Day 1 AM/PM, Day 2, etc.) and check-in options.',
      },
      {
        title: 'Decision Support',
        desc: 'Access the Decision Support tab to view Recharts visualizations of attendee punctuality, sex demographics, and evaluations.',
      },
    ],
    buttons: [
      {
        ...
        labelShort: 'Create',
        action: 'Opens the wizard to create a new activity with multi-session schedules.',
      },
      {
        label: 'Attach Document',
        labelShort: '+ Doc',
        action: 'Appends a new Google Drive documentation link to the activity.',
      },
    ],
  },
  '/unit-activity-scanner': {
    ...
    description:
      'Real-time terminal to scan participant QR codes, choose active session windows, and display feedback QR codes.',
    steps: [
      ...
      {
        title: 'Evaluation QR Overlay',
        desc: 'Open the Full Screen display or download the generated QR code to collect participant feedback.',
      },
    ],
    buttons: [
      { label: 'Change Session', labelShort: 'Session', action: 'Changes the active registration session window.' },
      {
        label: 'Display Evaluation QR',
        labelShort: 'QR Code',
        action: 'Opens a fullscreen modal with the Evaluation Portal QR code.',
      },
    ],
  },
  '/unit-activity/evaluate': {
    ...
    description:
      'Participant feedback terminal to evaluate activity objectives, speakers, organization/venue, and leave comments.',
    steps: [
      {
        title: 'Identify Yourself',
        desc: 'Optionally provide your name and contact details (submissions can be anonymous).',
      },
      {
        title: 'Provide Ratings',
        desc: 'Rate Objectives Met, Speaker Performance, and Venue/Organization quality from 1 to 5 stars.',
      },
    ...
    buttons: [
      {
        ...
        labelShort: 'Submit',
        action: 'Registers your responses in the QMS activity evaluation database.',
      },
    ],
  },
    ...
    buttons: [
      {
        ...
        labelShort: 'Radar',
        action: 'Visual map of quality assurance balance across pillars.',
      },
    ],
  },
    ...
    steps: [
      {
        ...
        desc: 'Add or modify the list of purposes, offices, and login options for the visitor logbook.',
      },
      {
        title: 'Set Defaults',
        desc: 'Configure default target offices and timezone settings for check-in operations.',
      },
